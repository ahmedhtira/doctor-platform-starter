...
export async function GET(
  ...
  // The redirect response itself receives Supabase's auth cookies.
  // This is the same response returned to the browser.
  const response = NextResponse.redirect(
    new URL(`/${safeLocale}/auth/set-password`, request.url),
    303,
  );
